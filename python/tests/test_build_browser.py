...
class BuildBrowserPayloadTests(unittest.TestCase):
    ...
    def test_generated_html_uses_clear_filters_and_message_targets(self) -> None:
        ...
        self.assertIn("MESSAGE_LIST_RENDER_CACHE", html)
        self.assertIn("CALL_LIST_RENDER_CACHE", html)
        self.assertIn("function messageListRenderSignature", html)
        self.assertIn("function callListRenderSignature", html)
        ...
        self.assertIn("calendar-activity-empty", html)
        self.assertIn("activity-calendar", html)
        self.assertIn("function isDatasetDateKey", html)
        self.assertIn("function defaultActivityDateToLatest", html)
        self.assertIn("No recovered data for that day", html)
        self.assertIn("Teams Activity Window", html)
        self.assertIn("function isDirectCoworkerThread", html)
        self.assertIn("function groupedMessageSnapshotMetrics", html)
        self.assertIn("Group/Meeting Chat Snapshot", html)
        self.assertIn("No direct coworker chat activity was found for this day.", html)
        ...
        self.assertNotIn("Chat avg response", html)
        self.assertNotIn("Chat average response", html)
